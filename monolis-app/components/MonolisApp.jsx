...
// ---------- local device storage (no login: the link itself is the key) ----------
...
function getLocalMemberId(tripId) {
  if (typeof window === "undefined") return null;
  return window.localStorage.getItem(memberKeyFor(tripId));
}
function setLocalMemberId(tripId, memberId) {
